...
function Navbar() {
    ...
    return (
        // default styling added to mobile screen then also for desktop screen.
        // if we want to display something only in desktop screen add 'md:'
        <>
            <nav className='navbar'>
                ...
                <div className={'absolute bg-white w-full left-0 top-full mt-0.5 border-b border-grey py-4 px-[5vw] md:border-0 md:block md:relative md:inset-0 md:p-0 md:w-auto md:show ' + (searchBoxVisible ? "show" : "hide")}>
                    <input
                        type='text'
                        placeholder='Search'
                        // md = medium screens | in descktop mode screen
                        className='w-full md:w-auto bg-grey p-4 pl-6 pr-[12%] md:pr-6 rounded-full placeholder:text-dark-grey md:pl-12'
                    />
                    {/* taken from flat-icons (search on google) */}
            ...
            {/* Outlet help to render nested routes */}
            <Outlet />
